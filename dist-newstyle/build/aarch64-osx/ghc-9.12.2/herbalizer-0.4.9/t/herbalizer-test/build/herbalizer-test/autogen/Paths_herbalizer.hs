...
-- at runtime using the environment variable herbalizer_bindir.
...
-- environment variable herbalizer_libdir.
...
-- using the environment variable herbalizer_dynlibdir.
...
-- runtime using the environment variable herbalizer_datadir.
...
-- using the environment variable herbalizer_sysconfdir.
...
bindir     = "/Users/benjamin/.cabal/bin"
libdir     = "/Users/benjamin/.cabal/lib/aarch64-osx-ghc-9.12.2-ea3d/herbalizer-0.4.9-inplace-herbalizer-test"
dynlibdir  = "/Users/benjamin/.cabal/lib/aarch64-osx-ghc-9.12.2-ea3d"
datadir    = "/Users/benjamin/.cabal/share/aarch64-osx-ghc-9.12.2-ea3d/herbalizer-0.4.9"
libexecdir = "/Users/benjamin/.cabal/libexec/aarch64-osx-ghc-9.12.2-ea3d/herbalizer-0.4.9"
sysconfdir = "/Users/benjamin/.cabal/etc"

getBinDir     = catchIO (getEnv "herbalizer_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "herbalizer_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "herbalizer_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "herbalizer_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "herbalizer_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "herbalizer_sysconfdir") (\_ -> return sysconfdir)
